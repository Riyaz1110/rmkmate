...
import { Calendar, MapPin, Award, FileText, X } from "lucide-react";
...
import invitaion1 from "@/assets/invitation1.jpeg";
import invitaion2 from "@/assets/invitation2.jpeg";
import invitationpdf from "@/assets/invitationpdf.pdf";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
              ...
              <div className="relative group w-full">
                ...
                <img
                  src={brochurePage1}
                  alt="Brochure Page 1"
                  className="rounded-2xl shadow-2xl w-full object-contain group-hover:scale-[1.02] transition duration-500 cursor-pointer"
                  onClick={() => setSelectedImage(brochurePage1)}
                />
              </div>
              ...
              <div className="relative group w-full">
                ...
                <img
                  ...
                  alt="Brochure Page 2"
                  className="rounded-2xl shadow-2xl w-full object-contain group-hover:scale-[1.02] transition duration-500 cursor-pointer"
                  onClick={() => setSelectedImage(brochurePage2)}
                />
              </div>
            </div>

            {/* Download Button */}
            <a href={brochurePDF} download="RMKMATE_2026_Brochure.pdf">
              <Button
                size="lg"
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col items-center gap-12">
            ...
            {/* Images Left and Right */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
              {/* Invitation Page 1 (Left) */}
              <div className="relative group w-full">
                <div className="absolute -inset-4 bg-primary/5 rounded-3xl -z-10 rotate-1" />
                <img
                  src={invitaion1}
                  alt="Invitation Page 1"
                  className="rounded-2xl shadow-xl w-full object-contain group-hover:scale-[1.02] transition duration-500 cursor-pointer"
                  onClick={() => setSelectedImage(invitaion1)}
                />
              </div>

              {/* Invitation Page 2 (Right) */}
              <div className="relative group w-full">
                <div className="absolute -inset-4 bg-primary/5 rounded-3xl -z-10 -rotate-1" />
                <img
                  src={invitaion2}
                  alt="Invitation Page 2"
                  className="rounded-2xl shadow-xl w-full object-contain group-hover:scale-[1.02] transition duration-500 cursor-pointer"
                  onClick={() => setSelectedImage(invitaion2)}
                />
              </div>
            </div>

            {/* Download Button */}
            <a href={invitationpdf} download="RMKMATE_2026_Invitation.pdf">
              <Button
                size="lg"
                className="mt-6 bg-blue-600 hover:bg-blue-700 text-white rounded-full px-12 h-14 text-lg shadow-lg border-0"
              >
                Download Invitation
              </Button>
            </a>
