          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="text-3xl font-bold text-primary line-through decoration-red-500 decoration-4">{d.date}</p>
              </Card>
            ))}
          </div>
        </section>
        ...
        <section>
          <Card className="relative overflow-hidden p-14 rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-2xl text-center">
            ...
            <div className="flex flex-col items-center">
              <button
                disabled
                className="px-12 py-4 text-lg font-bold bg-slate-200/50 text-slate-200 rounded-xl shadow cursor-not-allowed mb-6 opacity-70"
              >
                Submit via Microsoft CMT
              </button>
              <div className="inline-flex items-center gap-3 bg-red-500/20 px-6 py-3 rounded-full border border-red-500/30 backdrop-blur-sm">
