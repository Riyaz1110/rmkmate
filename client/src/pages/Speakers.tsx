...
import vinesh from "@/assets/vinesh.png"
import larra from "@/assets/larra.png"
import Nicolene from "@/assets/Nicolene.png"
import Kazushi from "@/assets/Kazushi.png"
/* ========= RMKMATE25 SPEAKERS ========= */
const speakers26 = [
    {
    name: "Dr Nicolene Murdoch",
    role: "Pro Vice-Chancellor (Educational Partnerships and Quality)",
  ...
  {
    name: "Dr. Bernard (Jim) Jansen ",
    role: "Editor in Chief - Information Processing and Management - Elsevier",
    affiliation: "Hamad Bin Khalifa University , Qatar",
    image: jim,
    bio: "Principal Scientist ,  Artificial intelligence - Qatar Computing Research Institute (QCRI)"
  },
  {
    name: "Dr. Kazushi IKEDA",
    role: "Mathematical Informatics Lab",
    affiliation: "Nara Institute of Science and Technology – Japan",
    image: Kazushi,
    bio: ""
  },
  {
    name: "Prof Dr Ir EUR ING Vinesh Thiruchelvam",
    role: "Chief Innovation & Enterprise Officer ",
    affiliation: "Asia Pacific University of Technology and Innovation – Malaysia",
    image: vinesh,
    bio: ""
  },
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-20">
      <div className="container mx-auto px-6">
        <SectionHeader title="Keynote Speakers - RMKMATE'26" />
