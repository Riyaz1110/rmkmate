          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex justify-between items-center border-b border-white/10 pb-2">
                ...
                <span className="font-medium text-white line-through decoration-red-500 decoration-2">Mar 10, 2026</span>
              </li>
              <li className="flex justify-between items-center border-b border-white/10 pb-2">
                <span className="text-slate-400">Acceptance Notification</span>
                <span className="font-medium text-white line-through decoration-red-500 decoration-2">Mar 31, 2026</span>
              </li>
              <li className="flex justify-between items-center border-b border-white/10 pb-2">
                <span className="text-slate-400">Last Date For Registration</span>
                <span className="font-medium text-white line-through decoration-red-500 decoration-2">Apr 10, 2026</span>
              </li>
              <li className="flex justify-between items-center border-b border-white/10 pb-2">
